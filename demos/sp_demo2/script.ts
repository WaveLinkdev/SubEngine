...
import { Bodies, Body, Composite, Composites, Constraint, Mouse, MouseConstraint } from "matter-js"
...
var mouse = Mouse.create(engine.Physics.Matter.render.canvas),
    mouseConstraint = MouseConstraint.create(engine.Physics.Matter, {
        mouse: mouse,
        constraint: {
            stiffness: 0.2,
            render: {
